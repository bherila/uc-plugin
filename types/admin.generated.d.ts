...
export type GenShopifyDetailQuery = { node?: AdminTypes.Maybe<(
    Pick<AdminTypes.ProductVariant, 'availableForSale' | 'inventoryQuantity'>
    & { product: Pick<AdminTypes.Product, 'title'>, inventoryItem: (
...
export type GetOrdersWithLineItemsQuery = { nodes: Array<AdminTypes.Maybe<(
    Pick<AdminTypes.Order, 'id' | 'cancelledAt' | 'createdAt' | 'email'>
    & { totalPriceSet: { shopMoney: Pick<AdminTypes.MoneyV2, 'amount'> }, totalShippingPriceSet: { shopMoney: Pick<AdminTypes.MoneyV2, 'amount'> }, lineItems: { nodes: Array<(
        Pick<AdminTypes.LineItem, 'quantity' | 'title'>
...
export type OrderEditAddLineItemDiscountMutationVariables = AdminTypes.Exact<{
  ...
  line_item_id: AdminTypes.Scalars['ID']['input'];
}>;
...
export type OrderEditAddLineItemDiscountMutation = { orderEditAddLineItemDiscount?: AdminTypes.Maybe<{ addedDiscountStagedChange?: AdminTypes.Maybe<(
      ...
      Pick<AdminTypes.CalculatedLineItem, 'id' | 'sku'>
      & { variant?: AdminTypes.Maybe<Pick<AdminTypes.ProductVariant, 'title' | 'id'>> }
